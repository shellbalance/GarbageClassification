package cn.itcast.garbageclassification.utils;

public class Constant {
    /**
     * 垃圾分类的key  请替换为自己的
     */
    public static final String KEY = "9e305f3b765eee8b0787df2821e84c89";
     ...
     */
    public static final String APP_ID = "28682446";

    /**
     * 百度图像识别 APP Key  GoodTrash
     */
    public static final String API_KEY = "x6DxlRTZkuOvIp7g2pfGEXpD";

    /**
     * 百度图像识别 APP Secret  GoodTrash
     */
    public static final String API_SECRET = "5OMyt1ETYeKMfp4oN1EHkThTTBokOj3u";

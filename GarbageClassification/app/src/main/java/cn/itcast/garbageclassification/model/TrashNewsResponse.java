...
public class TrashNewsResponse {
    ...
    private int code;
    private String msg;
    private List<TrashNewsResponse.NewslistBean> newslist;
    ...
    public List<TrashNewsResponse.NewslistBean> getNewslist() {
        return newslist;
    }

    public void setNewslist(List<TrashNewsResponse.NewslistBean> newslist) {
